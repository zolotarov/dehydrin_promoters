...
KS_dehydrins = open('../sequences/KS_dehydrins_pab.faa', 'w')
YnSKn_dehydrins = open('../sequences/YnSKn_dehydrins_pab.faa', 'w')
Kn_dehydrins = open('../sequences/Kn_dehydrins_pab.faa', 'w')
SKn_dehydrins = open('../sequences/SKn_dehydrins_pab.faa', 'w')
YnKn_dehydrins = open('../sequences/YnKn_dehydrins_pab.faa', 'w')
uncategorized_dehydrins = open('../sequences/uncategorized_dehydrins_pab.faa', 'w')

for record in SeqIO.parse('/home/yzolotarov/dehydrin_promoters/sequences/Pabies/dehydrins.fas', 'fasta',
                          alphabet=alphabet):
